 ...
 *  "DT_Facebook_Migration_xxxx", where xxxx is the migration number. For
 *  example:
 *
 *      class DT_Facebook_Migration_0002 extends DT_Facebook_Migration {
 *          // ...
 *      }
 *
 *  See the documentation for DT_Facebook_Migration_Engine.
 *
 */
abstract class DT_Facebook_Migration {
    ...
    /**
     * @throws \DT_Facebook_Migration_Test_Exception Table $name not as expected, see error log.
     */
    protected function test_expected_tables() {
        ...
        foreach ( $expected_tables as $name => $expected_table ) {
            ...
            if ( $got_table !== $expected_table ) {
                ...
                throw new DT_Facebook_Migration_Test_Exception( "Table $name not as expected, see error log" );
            }
        }
    }
...
/**
 * Class DT_Facebook_Migration_Test_Exception
 */
class DT_Facebook_Migration_Test_Exception extends Exception {
}
